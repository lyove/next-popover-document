...
const config = {
  ...
  organizationName: "lyove", // Usually your GitHub org/user name.
  projectName: "next-popover", // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/lyove/next-popover",
            label: "GitHub",
            position: "right",
          },
        ],
